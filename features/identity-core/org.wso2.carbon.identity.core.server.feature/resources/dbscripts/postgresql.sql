...
DROP TABLE IF EXISTS IDN_USER_FEATURE_LOCK_MAPPING;
CREATE TABLE IDN_USER_FEATURE_LOCK_MAPPING (
	ID VARCHAR(255) NOT NULL,
	USER_ID VARCHAR(255) NOT NULL,
	TENANT_ID INTEGER NOT NULL,
	FEATURE_ID VARCHAR(255) NOT NULL,
	IS_FEATURE_LOCKED BOOLEAN NOT NULL,
	FEATURE_UNLOCK_TIME BIGINT NOT NULL,
	FEATURE_LOCK_REASON VARCHAR(1023),
	FEATURE_LOCK_REASON_CODE VARCHAR(255),
	PRIMARY KEY (ID),
	CONSTRAINT IDN_USER_FEATURE_LOCK_MAPPING_CONSTRAINT UNIQUE (USER_ID, TENANT_ID, FEATURE_ID)
);

DROP TABLE IF EXISTS IDN_USER_FEATURE_LOCK_PROPERTY;
