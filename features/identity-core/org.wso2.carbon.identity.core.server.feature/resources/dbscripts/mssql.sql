...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_USER_FEATURE_LOCK_MAPPING]') AND TYPE IN (N'U'))
CREATE TABLE IDN_USER_FEATURE_LOCK_MAPPING (
	ID VARCHAR(255) NOT NULL,
	USER_ID VARCHAR(255) NOT NULL,
	TENANT_ID INTEGER NOT NULL,
	FEATURE_ID VARCHAR(255) NOT NULL,
	IS_FEATURE_LOCKED BIT NOT NULL,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_USER_FEATURE_LOCK_PROPERTY]') AND TYPE IN (N'U'))
CREATE TABLE IDN_USER_FEATURE_LOCK_PROPERTY (
	ID VARCHAR(255) NOT NULL,
	USER_ID VARCHAR(255) NOT NULL,
	TENANT_ID INTEGER NOT NULL,
	FEATURE_ID VARCHAR(255) NOT NULL,
	...
	PRIMARY KEY (ID),
	CONSTRAINT IDN_USER_FEATURE_LOCK_PROPERTY_CONSTRAINT UNIQUE (USER_ID, TENANT_ID, FEATURE_ID, PROPERTY_NAME)
);
